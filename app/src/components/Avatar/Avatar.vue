<template>
  <div :class="['avatar', `avatar__${size}`, classNames]">
...
export default class Avatar extends Vue {
  ...
  get classNames() {
    ...
    rounded && (classes += " avatar__rounded ");
    inline && (classes += " avatar__inline ");
    return classes.trim();
  }
...
.avatar {
  ...
  &__x-small,
  &__x-small .avatar__placeholder {
    @include size(24);
  }
  &__small,
  &__small .avatar__placeholder {
    @include size(32);
  }
  &__medium,
  &__medium .avatar__placeholder {
    @include size(48);
  }
  &__large,
  &__large .avatar__placeholder {
    @include size(64);
  }
